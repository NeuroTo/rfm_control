...
from rfm_control.config.config_types import MODEL_TYPE_GR00T, MODEL_TYPE_OCTO, MAPPER_TYPE_DEFAULT
from rfm_control.model_adapter.gr00t_adapter import Gr00tAdapter
from rfm_control.model_adapter.mapper.input.gr00t_input_mapper import Gr00tInputMapper
from rfm_control.model_adapter.mapper.input.octo_input_mapper import OctoInputMapper
...
from rfm_control.model_adapter.octo_adapter import OctoAdapter
...
from rfm_control.factories.gr00t_model_client_factory import Gr00tModelClientFactory
from rfm_control.factories.octo_model_client_factory import OctoModelClientFactory
from rfm_control.factories.gr00t_model_output_mapper_factory import Gr00tModelOutputMapperFactory
from rfm_control.factories.octo_model_output_mapper_factory import OctoModelOutputMapperFactory
...
class ModelAdapterFactory:
    ...
    def _create_gr00t_adapter(self, yaml_config: RfmConfigYaml, robot_configs: list[RobotConfig], image_configs: list[ImageConfig], image_handler: ImageHandler, joint_state_handler: JointStateHandler) -> ModelPort:
        ...
        # Import base class
        from rfm_control.config.model_client_config_base import Gr00tConfigBase
