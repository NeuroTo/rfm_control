...
python -m tng_control.config.validate_yaml gr00t_so101.yaml

# Validate all configs
python -m tng_control.config.validate_yaml -d .
```
...
```python
from tng_control.adapter_provider import AdapterProvider
...
python -m tng_control.config.validate_yaml my_robot_config.yaml
```
...
```bash
python -m tng_control.config.validate_yaml my_ur5_config.yaml
```
...
```python
from tng_control.config.config_types import CLIENT_TYPE_REAL, CLIENT_TYPE_MOCK
...
```python
from tng_control.config.config_types import MODEL_TYPE_RT1
...
```python
from tng_control.config.config_types import ModelType
...
```python
from tng_control.config.config_types import ACTION_MAPPER_TYPE_CARTESIAN
