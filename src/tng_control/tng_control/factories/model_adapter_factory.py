...
from tng_control.config.config_types import MODEL_TYPE_GR00T, MODEL_TYPE_OCTO, MAPPER_TYPE_DEFAULT
from tng_control.model_adapter.gr00t_adapter import Gr00tAdapter
from tng_control.model_adapter.mapper.input.gr00t_input_mapper import Gr00tInputMapper
from tng_control.model_adapter.mapper.input.octo_input_mapper import OctoInputMapper
...
from tng_control.observation_handler.image_handler import ImageHandler
...
from tng_control.factories.gr00t_model_client_factory import Gr00tModelClientFactory
from tng_control.factories.octo_model_client_factory import OctoModelClientFactory
from tng_control.factories.gr00t_model_output_mapper_factory import Gr00tModelOutputMapperFactory
from tng_control.factories.octo_model_output_mapper_factory import OctoModelOutputMapperFactory
...
class ModelAdapterFactory:
    ...
    def _create_octo_adapter(self, yaml_config: RfmConfigYaml, robot_configs: list[RobotConfig], image_configs: list[ImageConfig], image_handler: ImageHandler, joint_state_handler: JointStateHandler) -> ModelPort:
        ...
        # Import base class
        from tng_control.config.model_client_config_base import OctoConfigBase
