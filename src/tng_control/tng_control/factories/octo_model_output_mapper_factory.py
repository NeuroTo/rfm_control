...
from tng_control.config.config_types import MAPPER_TYPE_DEFAULT
from tng_control.model_adapter.mapper.output.delta_endeffector_mapper import OctoDeltaEndeffectorMapper
