...
```bash
cd tng_control/rfm_control/config/configs/
...
python -m tng_control.rfm_control.config.validate_yaml my_robot_config.yaml
```
...
```bash
python -m tng_control.rfm_control.config.validate_yaml my_ur5_config.yaml
```
...
```python
from tng_control.rfm_control.config.config_types import CLIENT_TYPE_REAL, CLIENT_TYPE_MOCK
...
```python
from tng_control.rfm_control.config.config_types import MODEL_TYPE_RT1
...
```python
from tng_control.rfm_control.config.config_types import ModelType
...
```python
from tng_control.rfm_control.config.config_types import ACTION_MAPPER_TYPE_CARTESIAN
